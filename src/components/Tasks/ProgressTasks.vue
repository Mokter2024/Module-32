...
<template>
  <div class="content-body container-fluid">
    ...
    <div class="row p-0 m-0">
      <div class="col-12 col-md-6 col-lg-8 px-3"><h5>Task In Progress</h5></div>
      <div class="col-12 float-end col-md-6 col-lg-4 px-2">
        <div class="row">
          <div class="col-8"><input class="form-control w-100" /></div>
          <div class="col-4">
    ...
    <ShimmerLoader :loading="taskStore.loading" :count="12" :lines="1">
      <div class="row p-0 m-0">
        <div
          class="col-12 col-lg-4 col-sm-6 col-md-4 p-2"
              ...
              <p class="m-0 animated fadeInUp p-0">
                ...
                ><a class="icon-nav text-danger mx-1"
                  ...
                  >
                    ...
                    ></path></svg></a
                ><a class="badge float-end bg-primary">Progress</a>
              </p>
            </div>
          </div>
        </div>
